...
import './OrdenProduccionComponentes.css';
import ConfirmModal from '../../components/ConfirmModal';
import Loading from '../../components/Loading';
import ToastMessage from '../../components/ToastMessage';
import OrdenProduccionWps from './OrdenProduccionWps';

const OrdenProduccionComponentes = () => {
    ...
    const handleConfirmAction = () => {
        console.log('Estoy en Componentes')
        setShowModalConfirm(false);
    ...
    return (
        <div className="detalle-orden-container">
            <div className="detalle-cabecera-produccion row">
            ...
            <Tabs
                ...
                className="custom-tabs mb-4 fs-4 py-2"
            >
                <Tab eventKey="componentes" className=''
                    title='Componentes'
                >
                ...
                >
                    {/* Sección de WPS */}
                    <OrdenProduccionWps isActive={activeTab === 'wps'} />
                </Tab>
            </Tabs>
...
export default OrdenProduccionComponentes;
